<!DOCTYPE html>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content border-0" style="background-color: #141432;">
              ...
              <div class="modal-footer border-0 gap-3" style="padding:	2rem; padding-top: 0.75rem">
                ...
                {{-- <button class="btn btn-fill border-0 text-white">Essayez</button> --}}
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="content-3-6 d-flex flex-column align-items-center h-100 flex-lg-row"
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
          ...
          <form style="margin-top: 1.5rem;" action="{{route("request_login_web")}}" method="post">
            @csrf
    ...
    <div class="empty-4-1" style="font-family: 'Poppins', sans-serif; margin-top:25px">
        <div class="mx-auto d-flex align-items-center justify-content-center flex-column">
            ...
            <div class="text-center w-100">
                ...
                <h3>
                    La devise appliquée à la grille est {{strtoupper($setting->default_currency)}}
                </h3>
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="zone_intl-tab" data-bs-toggle="tab" data-bs-target="#zone_intl" type="button" role="tab" aria-controls="home" aria-selected="true">INTERNATIONAL</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="zone_tg-tab" data-bs-toggle="tab" data-bs-target="#zone_tg" type="button" role="tab" aria-controls="profile" aria-selected="false">UNIQUEMENT AU TOGO</button>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="zone_intl" role="tabpanel" aria-labelledby="zone_intl-tab">
                                <div class="table-responsive" style="margin:20px">
                                    ...
                                    <table class="table table-hover data-table">
                                        ...
                                        <tbody>
                                        @foreach($priceListIntl as $pricelistItem)
                                            <tr>
                                                <td data-order="{{$pricelistItem->start}}">{{$pricelistItem->id}}</td>
                                                <td class="text-right">{{$pricelistItem->start}}</td>
                                                <td class="text-right">{{$pricelistItem->end}}</td>
                                                <td class="text-right">{{$pricelistItem->change}}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
                            ...
                            <div class="tab-pane fade" id="zone_tg" role="tabpanel" aria-labelledby="zone_tg-tab">
                                <div class="table-responsive" style="margin:20px">
                                    <p class="caption-text">
                                        Liste des taux des frais à ajouter lors de vos transactions vers le TOGO
                                    </p>
                                    <table class="table table-hover data-table">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        @foreach($priceListTogo as $pricelistItem)
                                            <tr>
                                                <td data-order="{{$pricelistItem->start}}">{{$pricelistItem->id}}</td>
                                                <td class="text-right">{{$pricelistItem->start}}</td>
                                                <td class="text-right">{{$pricelistItem->end}}</td>
                            ...
                            <table class="table table-hover data-table">
                                ...
                                <tbody>
                                    <tr>
                                      <td>1 GHS</td>
                                      <td>=&gt;</td>
                                      <td>{{to_fixed(strtoupper($conversions["ghs_to_xof"]))}} XOF</td>
                                    </tr>
                                    <tr>
                                      <td>1 XOF</td>
                                      <td>=&gt;</td>
                                      <td>{{to_fixed(strtoupper($conversions["xof_to_ghs"]))}} GHS</td>
                                    </tr>
                                </tbody>
                              </table>
                        </div>
                ...
                <div id="estimate_transfer_fees" class="d-flex justify-content-center" style="text-align: left;">
                    <form action="" style=" border:solid thin #524EEE; border-radius:10px; padding:25px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                ...
                                <div class="input-group col-xs-12">
                                    <select name="from" id="from" class="btn text-white" style="font-weight: bold; width:100%; background-color:var(--bs-indigo)">
                            ...
                            <div class="col-lg-4">
                              <div class="form-group">
                                ...
                                <div class="input-group col-xs-12">
                                    <select name="to" id="to" class="btn text-white" style="font-weight: bold; width:100%; background-color:var(--bs-indigo)">
                                        <option value="xof">XOF</option>
                                        <option value="ghs">GHS</option>
                                    </select>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <input id="for_tg" value="1" name="for_tg" type="checkbox">
                            <label for="for_tg">Le montant sera reçu au TOGO</label>
                        </div>
      ...
      <div class="container">
          ...
          <div class="row mx-0 button text-center">
              <div class="col-md-6 text-md-right mb-4 mb-md-0">
                  <a download href="{{asset("apps/mtransfert_android.apk")}}">
                      <img class="img-responsive" style="width: 250px; height:100px" src="{{asset("images/mobile/play_store.png")}}" alt="Download on playstore">
                  </a>
              </div>
              <div class="col-md-6 text-md-left mb-4 mb-md-0">
                  <a class="d">
                    <img class="img-responsive" style="width: 250px; height:90px" src="{{asset("images/mobile/app_store.png")}}" alt="Download on playstore">
                  </a>
              </div>
          </div>
      </div>
  ...
  <section class="h-100 w-100" style="box-sizing: border-box; background-color: #141432">
				...
				<div class="row gap-md-0 gap-3">
					...
					<div class="col-lg-4" id="footer_contacts">
						...
						<nav class="list-unstyled">
							<li class="list-space">
								<a href="tel:{{$accounts["BN"]}}" class="list-menu text-white">BENIN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;{{$accounts["BN"]}}<a/>
							</li>
							<li class="list-space">
								<a href="tel:{{$accounts["GH"]}}" class="list-menu text-white">GHANA&nbsp;&nbsp;:&nbsp;&nbsp;{{$accounts["GH"]}}</a>
							</li>
							<li class="list-space">
								<a href="tel:{{$accounts["TG"]}}" class="list-menu text-white">TOGO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;{{$accounts["TG"]}}</a>
							</li>
						</nav>
					</div>
					<div class="col-lg-4">
			...
			<div class="border-color info-footer">
				...
				<div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
					...
					<nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
						<p style="margin: 0">© 2021 - {{now()->format("Y")}} MTransfer | Designed by DEV-STUDIO</p>
					</nav>
				</div>
			</div>
		</div>
    ...
    <script>
        const currencyTo = $("#to");
        const forTogo = $("#for_tg")

        currencyTo.change(function(){
            if(this.value.toLowerCase() === 'xof'){
                $(forTogo).parent().get(0).style.display="block";
            }else{
                $(forTogo).parent().get(0).style.display="none";
            }
        });
        ...
        function estimateAmount() {
            ...
            if(for_togo.prop("checked")===true){
                formData.append("for_tg", "1");
            }else{
                formData.append("for_tg", "0");
            }
