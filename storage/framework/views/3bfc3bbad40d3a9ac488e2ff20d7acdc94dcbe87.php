    ...
    <div class="container-fluid page-body-wrapper">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                ...
                <?php if((userinfo(auth()->user())->level === 'Super Admin') || (auth()->user()->id == 10)): ?>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-pot">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('admin_transfer_points.index')); ?>">Liste</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('admin_transfer_points.create')); ?>">Ajouter</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link"
                                                    href='<?php echo e(route("admin_transactions.index")); ?>'>Liste</a></li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-price_list">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href='<?php echo e(route("admin_pricelist.index")); ?>'>Liste</a>
                            </li>
                            <li class="nav-item"><a class="nav-link"
                                                    href="<?php echo e(route("admin_pricelist.create")); ?>">Ajouter</a></li>
                        </ul>
                    </div>
                </li>
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span
                        class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2021-<?php echo e(now()->format('Y')); ?></span>
