        ...
        <div class="card-body">
          ...
          <table class="table" style="font-size:16px; font-weight:bolder">
            ...
            <tr>
              ...
              <td>=&gt;</td>
              <td><?php echo e(to_fixed(1/$transaction_rate["val"], 3)); ?> <?php echo e(strtoupper($transaction_rate["from"])); ?></td>
            </tr>
          </table>
...
<div id="attached_picture_modal" data-backdrop="static" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="proofPictureLabel" aria-hidden="true">
  <form>
      <?php echo csrf_field(); ?>
...
<?php if($validated): ?>
  <div id="validation_picture_modal" data-backdrop="static" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="validationPictureLabel" aria-hidden="true">
    <form>
        <?php echo csrf_field(); ?>
