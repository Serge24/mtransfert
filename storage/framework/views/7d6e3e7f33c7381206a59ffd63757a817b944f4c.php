...
<div class="content-wrapper">
  <div class="row">
    <div class="col-sm-12 mb-4 mb-xl-0">
      <h4 class="font-weight-bold text-dark">Bienvenue <?php echo e(userinfo(auth()->user())->name); ?></h4>
      <p class="font-weight-normal mb-2 text-muted"><?php echo e(now()->format('d/m/Y H:i:s')); ?></p>
    </div>
  </div>
  <div class="row mt-3">
...
<?php echo $__env->make('backend/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/m-transfert-laravel/resources/views/backend/pages/home.blade.php ENDPATH**/ ?>