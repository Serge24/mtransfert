            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="no_account" name="no_account" class="form-control" id="no_account" autocomplete="new-password" placeholder="Numéro de compte">
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="text" autocomplete="new-password" class="form-control" name="login" id="login" placeholder="Login">
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="password" autocomplete="new-password" class="form-control" name="password" id="password" placeholder="Password"/>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="password" autocomplete="new-password" class="form-control" name="passwordConfirm" id="passwordConfirm" placeholder="Password"/>
                </div>
              </div>
              ...
              <div class="col-lg-12">
                <div class="form-check form-check-flat form-check-success">
                  <label class="form-check-label" for="status">
                    <input type="checkbox" name="status" id="status" value="ACTIVE" class="form-check-input" checked />
