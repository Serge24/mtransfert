...
<?php $__env->startSection('content'); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table" style="font-size:16px; font-weight:bolder">
                            <tr>
                                <td>1 <?php echo e(strtoupper($transaction_rate['from'])); ?> </td>
                                <td>=&gt;</td>
                                <td><?php echo e($transaction_rate['val']); ?> <?php echo e(strtoupper($transaction_rate['to'])); ?></td>
                            </tr>
                            <tr>
                                <td>1 <?php echo e(strtoupper($transaction_rate['to'])); ?> </td>
                                <td>=&gt;</td>
                                <td><?php echo e(to_fixed(1 / $transaction_rate['val'], 2)); ?>

                                    <?php echo e(strtoupper($transaction_rate['from'])); ?></td>
                            </tr>
                        </table>
                            ...
                            <table class="table table-hover table-bordereds">
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:bolder">
                                        1 <?php echo e(strtoupper($transaction_rate['from'])); ?> =&gt; <?php echo e(to_fixed($transaction_rate['val'], 5)); ?> <?php echo e(strtoupper($transaction_rate['to'])); ?>

                                        <br /> <br />
                                        1 <?php echo e(strtoupper($transaction_rate['to'])); ?> =&gt; <?php echo e(to_fixed(1 / $transaction_rate['val'], 5)); ?> <?php echo e(strtoupper($transaction_rate['from'])); ?>
    ...
    <div id="attached_picture_modal" data-backdrop="static" class="modal fade" tabindex="-1" role="dialog"
    ...
    <?php if($validated): ?>
        <div id="validation_picture_modal" data-backdrop="static" class="modal fade" tabindex="-1" role="dialog"
